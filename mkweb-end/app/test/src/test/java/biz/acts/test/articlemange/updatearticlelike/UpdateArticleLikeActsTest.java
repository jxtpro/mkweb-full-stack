...
package biz.acts.test.articlemange.updatearticlelike;
 ...
 * @version $Id: UpdateArticleLikeActsTest.java,v 0.1 2020-04-06 上午 11:51:09 Administrator Exp $
 */
@SpringBootTest(classes = SOFABootTestApplication.class)
public class UpdateArticleLikeActsTest extends ActsTestBase {
   ...
   *
   * <p>{@link com.soft.sakd.biz.mange.ArticleMange#updateArticleLike(java.lang.Long)}
   */
  @Test(dataProvider = "ActsDataProvider")
  public void updateArticleLike(String caseId, String desc, PrepareData prepareData) {
