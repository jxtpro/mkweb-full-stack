...
package biz.acts.test.articlemange.updatearticlebrowse;
 ...
 * @version $Id: UpdateArticleBrowseActsTest.java,v 0.1 2020-04-06 上午 11:51:41 Administrator Exp $
 */
@SpringBootTest(classes = SOFABootTestApplication.class)
public class UpdateArticleBrowseActsTest extends ActsTestBase {
   ...
   *
   * <p>{@link com.soft.sakd.biz.mange.ArticleMange#updateArticleBrowse(java.lang.Long)}
   */
  @Test(dataProvider = "ActsDataProvider")
  public void updateArticleBrowse(String caseId, String desc, PrepareData prepareData) {
