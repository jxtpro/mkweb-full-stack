 ...
 */
package com.alipay.sakd.servicetest.base;
...
public class SakdActsBaseUtils {
   ...
   * @param paramValue
   */
  public static void putExpSpecialParamForCheck(
      ActsRuntimeContext actsRuntimeContext, String paramKey, Object paramValue) {
   ...
   * @param paramMap
   */
  public static void putListExpSpecialParamForCheck(
      ActsRuntimeContext actsRuntimeContext, Map<String, Object> paramMap) {
   ...
   * @return
   */
  public static Object getUserDifinedParamByKey(
      String paramKey, ActsRuntimeContext actsRuntimeContext) {
    return actsRuntimeContext.prepareData.getVirtualParams().getParams().get(paramKey).getObject();
  }
   ...
   * @return
   */
  public static List<Map<String, Object>> getQueryResultMap(
      String sql, String tableName, String dbConfigKey) {
