...
package biz.acts.test.articlemange.queryall;
 ...
 * @version $Id: QueryAllActsTest.java,v 0.1 2020-04-06 上午 11:49:56 Administrator Exp $
 */
@SpringBootTest(classes = SOFABootTestApplication.class)
public class QueryAllActsTest extends ActsTestBase {
   ...
   *
   * <p>{@link com.soft.sakd.biz.mange.ArticleMange#queryAll(int, int)}
   */
  @Test(dataProvider = "ActsDataProvider")
  public void queryAll(String caseId, String desc, PrepareData prepareData) {
